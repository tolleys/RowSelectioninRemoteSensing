...
### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ###
#####SbDIV18 Yield 
SbDIV18_Yield <- read.csv("/scratch/bell/tolleys/UAV_DATA/MLPrediction/SbDIV18/sbdiv_biomass_final_updated_Ali.csv", header=TRUE, )[,c(1,12)]
#SbDIV18_Yield <- read.csv("~/Documents/Purdue/PhD/Research/Chp3_RowSelection/DATA_Processing/Yield/sbdiv_biomass_final_updated_Ali.csv", header=TRUE, )[,c(1,12)]
...
SbDIV18 <- read_excel("/scratch/bell/tolleys/UAV_DATA/MLPrediction/SbDIV18/RowSelection_AllData_sat.xlsx", sheet=1, na = "NA")
...
SbDIV18 <- SbDIV18 %>%
  select(grep("Plot", names(SbDIV18)),
         grep("RowSegment", names(SbDIV18)),
         grep("Trim", names(SbDIV18)),
         grep("CC_", names(SbDIV18)),
         grep("canopy_cover_10", names(SbDIV18)),
         grep("height_95", names(SbDIV18)),
         grep("plot_volume", names(SbDIV18)),
         grep("NDVI", names(SbDIV18)))

SbDIV18 = SbDIV18[,!grepl("GNDVI",names(SbDIV18))]; SbDIV18 = SbDIV18[,!grepl("mRE",names(SbDIV18))]; SbDIV18 = SbDIV18[,!grepl("20180806",names(SbDIV18))]
...
RS1234 <- SbDIV1234 %>%
  group_by(Plot) %>%
  summarise_at(vars(CC_20180604:NDVI_20180802), mean, na.rm = TRUE)
...
save.image(file='/scratch/bell/tolleys/UAV_DATA/MLPrediction/SbDIV18/SbDIV18_svmRadial_workspace.RData')
