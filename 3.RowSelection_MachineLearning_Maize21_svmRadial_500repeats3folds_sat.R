####Author: Seth Tolley
####Date:   12/03/2021
####This script is to get the prediction accuracy of RS traits predicting grain yield
...
### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ###
#####JCEager21 Yield 
JCEager21_Yield <- read_excel("/scratch/bell/tolleys/UAV_DATA/MLPrediction/JCEager21/21JCEager_YieldData_sat.xlsx", sheet=1)[,c(1,2,3,19)]
#JCEager21_Yield <- read_excel("~/Documents/Purdue/PhD/Research/Chp3_RowSelection/DATA_Processing/Yield/21JCEager_YieldData_sat.xlsx", sheet=1)[,c(1,2,3,19)]
...
JCEager21 <- read_excel("/scratch/bell/tolleys/UAV_DATA/MLPrediction/JCEager21/RowSelection_AllData_sat.xlsx", sheet=5, na = "NA")
...
JCEager21 <- JCEager21 %>%
 select(grep("Plot", names(JCEager21)),
        grep("RowSegment", names(JCEager21)),
        grep("Trim", names(JCEager21)),
        grep("CC_", names(JCEager21)),
        grep("canopy_cover_10", names(JCEager21)),
        grep("height_95", names(JCEager21)),
        grep("plot_volume", names(JCEager21)),
        grep("NDVI", names(JCEager21)))

JCEager21 = JCEager21[,!grepl("GNDVI",names(JCEager21))]; JCEager21 = JCEager21[,!grepl("mRE",names(JCEager21))]
...
RS1234 <- JCEager1234 %>%
  group_by(Plot) %>%
  summarise_at(vars(CC_20210610:NDVI_20210910), mean, na.rm = TRUE)
...
save.image(file='/scratch/bell/tolleys/UAV_DATA/MLPrediction/JCEager21/JCEager21_svmRadial_500repeats3folds_workspace.RData')
#save.image(file='~/Documents/Purdue/PhD/Research/Chp3_RowSelection/DATA_Processing/MLPrediction_Workspaces/JCEager21_svmRadial_500repeats3folds_workspace.RData')
