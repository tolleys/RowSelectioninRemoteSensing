...
### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ###
#####SbDIV19 Yield 
SbDIV19_Yield <- read.csv("/scratch/bell/tolleys/UAV_DATA/MLPrediction/Yield/MachineHarvestSbdivTC_09_12_2019.csv", header=TRUE, )[,c(1,13)]
SbDIV19_Yield <- na.omit(SbDIV19_Yield)
head(SbDIV19_Yield)


SbDIV19 <- read_excel("/scratch/bell/tolleys/UAV_DATA/MLPrediction/RowSelection_AllData_sat.xlsx", sheet=2, na = "NA")
SbDIV19 = SbDIV19[,!grepl("intensity",names(SbDIV19))]; SbDIV19 = SbDIV19[,!grepl("_ht",names(SbDIV19))]; SbDIV19 = SbDIV19[,!grepl("_int",names(SbDIV19))]
...
save.image(file='/scratch/bell/tolleys/UAV_DATA/MLPrediction/SbDIV19_svmRadial_workspace.RData')
