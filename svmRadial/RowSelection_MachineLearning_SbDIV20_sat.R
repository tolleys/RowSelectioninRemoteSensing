...
### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ###
#####SbDIV20 Yield 
SbDIV20_Yield <- read_excel("/scratch/bell/tolleys/UAV_DATA/MLPrediction/Yield/WL20 54S biomass Final.xlsx", sheet=2, na = "NA")[,c(1,13)]
SbDIV20_Yield <- na.omit(SbDIV20_Yield)
head(SbDIV20_Yield)


SbDIV20 <- read_excel("/scratch/bell/tolleys/UAV_DATA/MLPrediction/RowSelection_AllData_sat.xlsx", sheet=3, na = "NA")
SbDIV20 = SbDIV20[,!grepl("intensity",names(SbDIV20))]; SbDIV20 = SbDIV20[,!grepl("_ht",names(SbDIV20))]; SbDIV20 = SbDIV20[,!grepl("_int",names(SbDIV20))]
...
save.image(file='/scratch/bell/tolleys/UAV_DATA/MLPrediction/SbDIV20_svmRadial_workspace.RData')
